...
|---|---|---|
| **Concurrent Access** | လူအများပြိုင်တူ ရေးပါက ဖိုင် ပျက်စီးနိုင်သည် (File Lock Issue) | ဧည့်သည် သောင်းပေါင်းများစွာ ပြိုင်တူ သုံးစွဲနိုင်သည် (Row-Level Locking) |
...
Database ၏ သဘောတရားကို ရုံးသုံး ဖိုင်တွဲဗီရို (Filing Cabinet) နှင့် နှိုင်းယှဉ်ကြည့်ပါက အလွန်လွယ်ကူစွာ နားလည်နိုင်ပါသည်။
...
- **Primary Key (PK)** — Table တစ်ခုအတွင်းရှိ Record တစ်ကြောင်းချင်းစီကို ထူးခြားစွာ မှတ်ပုံတင်ပေးသော ID ဖြစ်ပါသည်။ (မထပ်ရပါ၊ NULL မဖြစ်ရပါ)။
