...
ဤသင်ခန်းစာတွင် ရရှိလာသော Data များကို အစဉ်လိုက် (အနည်းမှ အများ သို့ အများမှ အနည်း) စီစဉ်ခြင်း (ORDER BY) နှင့် ထွက်လာမည့် Data အရေအတွက်ကို ကန့်သတ်ကြည့်ရှုခြင်း (LIMIT & OFFSET) တို့ကို လေ့လာသွားပါမည်။
...
### ဥပတွင် (၁) - စျေးနှုန်း အသက်သာဆုံးမှ စတင်စီခြင်း
```sql
SELECT name, price FROM products ORDER BY price ASC;
```

### ဥပတွင် (၂) - စျေးနှုန်း အကြီးဆုံးမှ စတင်စီခြင်း
```sql
...
ယခုအခါ Single Table ကို ကျွမ်းကျင်သည် ကိုင်တွယ်နိုင်ပြီဖြစ်လို့ Table များကို ပေါင်းစပ်ပြီးလျှင် Data ထုတ်ယူနည်း (JOINs) ကို ဆက်လက် လေ့လာကြပါစို့။
