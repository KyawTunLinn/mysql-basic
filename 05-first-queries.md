...
ဤသင်ခန်းစာတွင် မူလ Sample Database ကို အသုံးပြုပြီးလျှင် ပထမဆုံး SQL Query များ ရေးသားပြီးလျှင် Data ထုတ်ယူနည်းကို လေ့လာသွားပါမည်။
...
သို့မဟုတ် MySQL ထဲတွင် ရောက်ရှိနေပါက -
...
`Database changed` ဟု ပေါ်လာပါမည်။ ယခုအခါ ပြုလုပ်သမျှ Command အားလုံးသည် `shop` Database ပေါ်တွင် သက်ရောက်ပါမည်။
...
Data တန်းပေါင်း ထောင်ချီ ရှိနေပါက အားလုံး ပေါ်လာလျှင် ကြည့်ရ ခက်ခဲပါမည်။ ထို့ကြောင့် စတင် ကြည့်ရှုချိန်တွင် `LIMIT` ကို အသုံးပြုပြီးလျှင် အရေအတွက် ကန့်သတ်ကြည့်ရပါတယ်။
