...
ဤသင်ခန်းစာတွင် မိမိ၏ Database များကို ဘေးကင်းသည် Backup သိမ်းဆည်းနည်းနှင့် ပျက်စီးသွားပါက ပြန်လည် ယူငင်နည်း (Restore) တို့ကို လေ့လာသွားပါမည်။ ဤနည်းလမ်းသည် ဒေတာ ပျက်စီးမှုမှ ကာကွယ်ရန် အရေးကြီးဆုံး လုပ်ဆောင်ချက် ဖြစ်ပါတယ်။
...
`mysqldump` သည် Database တစ်ခုလုံးကို ပြန်လည် တည်ဆောက်နိုင်သော SQL Command ဖိုင် (`.sql`) အဖြစ် သိမ်းဆည်းပေးပါသည်။
...
သင်သည် MySQL အခြေခံ သင်ခန်းစာ (၁၄) ခုလုံးကို အောင်မြင်သည် လေ့လာ ပြီးဆုံးခဲ့ပြီ ဖြစ်ပါတယ်။

###  သင်ခန်းစာများ အောင်မြင်သည် ပြီးဆုံးပါပြီ! (Course Completed!)
