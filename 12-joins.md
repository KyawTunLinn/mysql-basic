...
၁. Orders နန့် Customers ကို INNER JOIN ဖြင့် ပေါင်းပနာ အော်ဒါ စာရင်း ထုတ်ပြပါ။
၂. တစ်ခါမျှ အော်ဒါ ဝယ်ယူခြင်း မဟိဖူးသော ဝယ်သူများကို ရှာပါ။ (LEFT JOIN + WHERE IS NULL)
၃. ဝယ်ယူထားသော ပစ္စည်း အမည်၊ ဝယ်သူ အမည်နန့် စျေးနှုန်းများကို Table ၃ ခု JOIN ပနာ ထုတ်ပြပါ။
