...
**JOIN** ဆိုသည်မှာ Table နှစ်ခု သို့မဟုတ် နှစ်ခုထက်ပိုသော Table များကို ပေါင်းစပ်ပြီးလျှင် Data ထုတ်ယူသည့် စနစ်ဖြစ်ပါတယ်။ ယင်းသည် Database တွင် အရေးအပါဆုံးနှင့် စွမ်းအားအထက်မြက်ဆုံး သဘောတရား ဖြစ်ပါတယ်။
...
Table နှစ်ခုလုံးတွင် ဒေတာ ကိုက်ညီမှု ရှိသော အတန်းများကိုသာ ထုတ်ပြပေးပါမည်။
...
လက်ဝဲဘက် Table တွင်ရှိသော အချက်အလက်များ အားလုံး ပေါ်လာမည်ဖြစ်ပြီးလျှင် လက်ညာဘက် Table တွင် မရှိပါက `NULL` ဟု ပြပါမည်။
