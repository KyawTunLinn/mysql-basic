...
Terminal တွင် အောက်ပါ command ကို ရိုက်ထည့်ပြီးလျှင် Enter နှိပ်ပါ -
...
အတည်ပြုပြီးပါက `mysql>` ဟု ပေါ်လာပါမည်။ ယင်းသည် MySQL ထဲသို့ အောင်မြင်သည် ရောက်ရှိသွားပြီဖြစ်ပါတယ်။

---

##  အဆင့် ၃ - ပထမဆုံး Command ကို စမ်းသပ်ပါ

`mysql>` Prompt တွင် အောက်ပါအတိုင်း ရိုက်ထည့်ပြီးလျှင် Enter နှိပ်ပါ -
...
SQL Command တိုင်း၏ အဆုံးတွင် Semicolon (`;`) မဖြစ်မနေ ပါရပါမည်။
