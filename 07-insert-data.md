...
![INSERT INTO Illustration](images/lesson07.svg)

ဖန်တီးထားသော Table ဇယားများထဲသို့ Data အသစ်များကို `INSERT INTO` အသုံးပြုပြီးလျှင် စနစ်တကျ ထည့်သွင်းနည်း ဖြစ်ပါတယ်။
(INSERT) ကို လေ့လာသွားပါမည်။
